package speed.com.shoppingbackend.config;
...
@Configuration
@ComponentScan(basePackages = { "speed.com.shoppingbackend.dto" })
@EnableTransactionManagement
public class HibernateConfig {

	// change below based on database
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
        ...
        builder.scanPackages("speed.com.shoppingbackend");
